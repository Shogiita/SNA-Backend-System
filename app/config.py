...
if not IG_ACCESS_TOKEN or IG_ACCESS_TOKEN == "MASUKKAN_ACCESS_TOKEN_ANDA_YANG_SUDAH_DIGENERATE":
    ...
    # Anda bisa memilih untuk raise error di sini jika token wajib ada saat startup
    # raise ValueError("INSTAGRAM_ACCESS_TOKEN tidak ditemukan atau masih placeholder.")
